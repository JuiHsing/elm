//Fri Aug 23 2024 15:17:16 GMT+0800 (China Standard Time)
...
const _0x57ecf6 = [
    ...
    {sendNotify: sendNotify} = require("./sendNotify1.js"),
...
function _0x533bff(_0x24e93b = 0, _0x11eeb2 = 100) {
    return Math.min(
        Math.floor(_0x24e93b + Math.random() * (_0x11eeb2 - _0x24e93b)),
        _0x11eeb2
    );
}
...
function _0x458c4f(_0x2dbe1b) {
    ...
    for (
        var _0x17f49a = _0x2dbe1b.split(";"), _0xe4d83b = 0;
        _0xe4d83b < _0x17f49a.length;
        _0xe4d83b++
    ) {
...
function _0x2c737d(_0x26ac3f, _0x3147d7, _0xf49249, _0x26309a, _0x4e9280 = 5) {
    ...
    return (
        (_0x40318d.headers.Cookie = _0x26ac3f),
            (_0x40318d.headers.method = "GET"),
            (_0x40318d.headers["User-Agent"] =
                ...
                try {
                    request(_0x40318d, async (_0x2e4542, _0x27253c, _0x101d13) => {
                        if (!_0x2e4542 && _0x27253c.statusCode === 200) {
                            ...
                            _0x4e9280 <= 0
                                ? (console.log("第", _0x3147d7 + 1, "cookie存在异常，请检查"),
                                    _0x73fab4(null))
                                : _0x73fab4(
                                    await _0x539aac(
                                        _0x26ac3f,
...
function _0xebb331(_0xe3833b, _0x2f901e, _0x38a366) {
    let _0x4b303e = false;
    for (
        var _0x2424dd = _0x38a366.split(";"), _0x4f5e57 = 0;
        _0x4f5e57 < _0x2424dd.length;
        _0x4f5e57++
    ) {
    ...
    var _0x268beb = "";
    if (_0x4b303e)
        for (_0x4f5e57 = 0; _0x4f5e57 < _0x2424dd.length; _0x4f5e57++) {
...
const _0x539aac = async (
        ...
        let _0x2c1f88 = {},
            ...
            _0xd5837c = await _0x249dba(
                _0x452452 + "&" + _0xec4d2a + "&" + _0x211506 + "&" + _0x286776,
                _0x1200ab,
                _0x7f153d
            );
        const _0x191115 = {
            ...
            try {
                request(_0x9e47aa, async (_0x2ab465, _0x30535b, _0x3c0e12) => {
                    if (!_0x2ab465 && _0x30535b.statusCode === 200) {
                        ...
                        _0x478a0b.data.errorCode === "000502"
                            ? (console.log(
                                "第",
                                _0x22a09c + 1,
                                "账号失效！请重新登录！！！😭"
                                ...
                                _0x31f74c(null))
                            : (_0x3fefd6 <= 0 &&
                            (console.log("第", _0x22a09c + 1, "cookie存在异常，请检查"),
                                _0x31f74c(null)),
                                _0x478a0b.ret.includes("FAIL_SYS_TOKEN_EXOIRED::令牌过期") ||
                                _0x478a0b.ret.includes("FAIL_SYS_TOKEN_EMPTY::令牌为空")
                                    ? _0x31f74c(
                                        await _0x2c737d(
                                            _0x3e1510,
                                            _0x22a09c,
    ...
    _0x115399 = async (_0x4a0861, _0x390437, _0xffee8b, _0x5cd102 = 5) => {
        ...
        let _0x3ddafa = {},
            ...
            _0x8edbd2 = await _0x249dba(
                _0x105cd5 + "&" + _0x2c4113 + "&" + _0x56cc73 + "&" + _0x5ede1a,
                _0x390437,
                _0xffee8b
            );
        const _0x48a3fa = {
                ...
                request(_0x3fede4, async (_0x561bd4, _0x439cef, _0x3dce19) => {
                    if (!_0x561bd4 && _0x439cef.statusCode === 200) {
                        ...
                        if (_0x5acf3c.data.errorCode === "000502") {
                            ...
                            _0x5cd102 <= 0 &&
                            (console.log("cookie 存在异常，请确认"), _0x43024b(null)),
                                _0x5acf3c.ret.includes("FAIL_SYS_TOKEN_EXOIRED::令牌过期") ||
                                _0x5acf3c.ret.includes("FAIL_SYS_TOKEN_EMPTY::令牌为空")
                                    ? _0x43024b(
                                        await _0x45baa7(
                                            _0x4a0861,
                                            _0x390437,
...
function _0x45baa7(_0x16cc01, _0x467f12, _0x34125f, _0x2bad50 = 5) {
    ...
    return (
        (_0x330b76.headers.Cookie = _0x16cc01),
            (_0x330b76.headers.method = "GET"),
            (_0x330b76.headers["User-Agent"] =
                "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.87 Safari/537.36"),
            _0x5bcbae((_0x5b3daf) => {
                try {
                    request(_0x330b76, async (_0x2ad3b, _0x26475c, _0x37ce70) => {
                        if (!_0x2ad3b && _0x26475c.statusCode === 200) {
                            ...
                            if (_0x2bad50 <= 0)
                                console.log("cookie 存在异常，请确认"), _0x5b3daf(null);
                            else {
                                _0x5b3daf(
                                    await _0x115399(_0x16cc01, _0x467f12, _0x34125f, _0x2bad50 - 1)
                                );
                            }
                        } else _0x5b3daf(null);
                    });
...
function _0x51a5e8(_0x1f6b67) {
    return new Promise((_0x459011) => {
        _0x355d3c(_0x1f6b67, function (_0x5195f2, _0x4a79cc, _0xcfcf33) {
            if (_0x5195f2) console.error(_0x5195f2), _0x459011("");
            else {
                _0x459011(_0x4a79cc);
            }
        });
...
function _0x10d424(_0x18bf21) {
    const _0x5d8a4c = _0x18bf21
            .split(";")
            .map((_0x428126) => _0x428126.trim().split("=")),
        _0x3b8de9 = new Map();
    ...
    return new Promise((_0x2c8c7e, _0x53d992) => {
        ...
        function _0x453f5e(_0x2a9216, _0x36a37d, _0x3afee9) {
            if (!_0x2a9216 && _0x36a37d.statusCode == 200) {
                ...
                _0xadf90a && _0xadf90a.data
                    ? _0x2c8c7e(_0xadf90a.data)
                    : _0x53d992("请求失败");
            } else {
...
async function _0x5a1592(_0x3b367d, _0x1ef5ce) {
    ...
    return _0x5bcbae((_0x2aaa56) => {
        request(_0x2cc5f5, async (_0x4090e0, _0xcf0d13, _0x1cbb01) => {
            if (!_0x4090e0 && _0xcf0d13.statusCode === 200)
                try {

...
const kami = process.env.ELE_CARME ? process.env.ELE_CARME : "1";
...
async function gameRequest(_0x108364, _0x2cb520) {
    ...
    const _0x2a5ef3 = await sign(
        ...
        _0x45614e +
        "&" +
        JSON.stringify(_0x2cb520),
        kami
    );
    const _0x92c123 = {
        url:
            "https://shopping.ele.me/h5/mtop.miniapp.cloud.application.request/1.0/?jsv=2.6.1&appKey=34190632&t=" +
            _0xeda03f +
            "&sign=" +
            _0x2a5ef3 +
            "&api=mtop.miniapp.cloud.application.request&v=1.0&type=originaljson&ttid=1608030065155%40eleme_android_11.0.38",
        method: "POST",
        headers: _0x14ca42,
        body: _0x25963c,
    };
...
async function getOpenId(_0x517db7) {
    ...
    const _0x510cf2 = {
        ...
        method: "POST",
        options:
            '{"cloudAppId":"45504","timeout":200,"env":"online","options":{"path":"pages/index/index"}}',
        path: "/getopenid",
        protocols:
...
function addjb(_0x22cd6d, _0x5c6186) {
    ...
    let _0x1be390 = taobaoRequest({
        ...
        mini_game_grant_integral_request: {
            ...
            request_id: md5(
                "dcc2920acdae1fdea78cef9c187af558" +
                _0x1afe03 +
    ...
    var _0x231acb = encodeURIComponent(
        _0x1be390.mini_game_grant_integral_request
    );
    const _0x474154 = _0x1be390.sign;
    const _0x55a70c = {
        url:
            "https://eco.taobao.com/router/rest?app_key=34315415&format=json&method=alibaba.alsc.growth.interactive.mini.game.integral.grant&mini_game_grant_integral_request=" +
            _0x231acb +
            "&sign=" +
            _0x474154 +
            "&sign_method=md5&timestamp=" +
            _0x1be390.timestamp +
            "&v=2.0",
        method: "GET",
        headers: _0x2baad0,
    ...
    return tryCatchPromise((_0x344fdb) => {
        request(_0x55a70c, async (_0xc6cd8b, _0x39a2d8, _0x315255) => {
            if (!_0xc6cd8b && _0x39a2d8.statusCode == 200) {
                ...
                if (
                    _0x23052d
                        .alibaba_alsc_growth_interactive_mini_game_integral_grant_response
                        .data
                ) {
                    console.log(
                        "玩 2048 获得",
...
function taobaoRequest(_0x178a27) {
    ...
    for (var _0x41f90f in _0x178a27)
        Object.prototype.hasOwnProperty.call(_0x178a27, _0x41f90f) &&
        ("object" == typeof _0x178a27[_0x41f90f]
            ? (_0x5bf7ee[_0x41f90f] = JSON.stringify(_0x178a27[_0x41f90f]))
            : (_0x5bf7ee[_0x41f90f] = _0x178a27[_0x41f90f]));
    _0x5bf7ee = sortASCII(_0x5bf7ee, !0);
    var _0x3753c2 = "";
    for (var _0x41f90f in _0x5bf7ee)
        Object.prototype.hasOwnProperty.call(_0x5bf7ee, _0x41f90f) &&
        ((_0x3753c2 += _0x41f90f),
            "object" == typeof _0x5bf7ee[_0x41f90f]
                ? (_0x3753c2 += JSON.stringify(_0x5bf7ee[_0x41f90f]))

...
function Env(_0x1759e6, _0x1c342e) {
  "denifednu".split("").reverse().join("") != typeof process &&
    JSON["stringify"](process["env"])["indexOf"]("GITHUB") >
      -(0xee163 ^ 0xee162) &&
  ...
  class _0x5b3a29 {
    ...
    ["dnes".split("").reverse().join("")](
      _0x2629a2,
      _0x211493 = "TEG".split("").reverse().join("")
    ) {
      _0x2629a2 =
        "gnirts".split("").reverse().join("") == typeof _0x2629a2
          ? { url: _0x2629a2 }
          : _0x2629a2;
      let _0x5a2f16 = this["get"];
      return (
        "POST" === _0x211493 && (_0x5a2f16 = this["post"]),
        new Promise((_0x178f13, _0x51b2d5) => {
          _0x5a2f16["call"](
            this,
            _0x2629a2,
            (_0x22a257, _0x4e7aa2, _0x4fc604) => {
  ...
  return new (class {
    ...
    ["getScript"](_0x1a32d1) {
      return new Promise((_0x1d598b) => {
        this["get"]({ url: _0x1a32d1 }, (_0x532d08, _0x44a9f8, _0x3a17f3) =>
          _0x1d598b(_0x3a17f3)
        );
      });
    }
    ["runScript"](_0x469436, _0x6dc920) {
      return new Promise((_0x2f9842) => {
        let _0x3d519d = this["getdata"](
          "ipaptth.sgfCresu_sjxob_yvahc@".split("").reverse().join("")
        );
        _0x3d519d = _0x3d519d
          ? _0x3d519d["replace"](/\n/g, "")["trim"]()
          : _0x3d519d;
        let _0xb150d4 = this["\u0067\u0065\u0074\u0064\u0061\u0074\u0061"](
          "\u0040\u0063\u0068\u0061\u0076\u0079\u005f\u0062\u006f\u0078\u006a\u0073\u005f\u0075\u0073\u0065\u0072\u0043\u0066\u0067\u0073\u002e\u0068\u0074\u0074\u0070\u0061\u0070\u0069\u005f\u0074\u0069\u006d\u0065\u006f\u0075\u0074"
        );
        (_0xb150d4 = _0xb150d4 ? 0x1 * _0xb150d4 : 0x14),
          (_0xb150d4 =
            _0x6dc920 && _0x6dc920["timeout"]
              ? _0x6dc920["timeout"]
              : _0xb150d4);
        const [_0x9bcfd0, _0x533f9c] = _0x3d519d["split"]("@"),
          _0x388212 = {
            url:
              "\u0068\u0074\u0074\u0070\u003a\u002f\u002f" +
              _0x533f9c +
              "etaulave/gnitpircs/1v/".split("").reverse().join(""),
            body: {
        ...
        this["\u0070\u006f\u0073\u0074"](
          _0x388212,
          (_0x50b05c, _0x7a22f8, _0xa79ec2) => _0x2f9842(_0xa79ec2)
        );
    ...
    ["ataddaol".split("").reverse().join("")]() {
      if (!this["\u0069\u0073\u004e\u006f\u0064\u0065"]()) return {};
      {
        (this["fs"] = this["fs"]
          ? this["fs"]
          : require("sf".split("").reverse().join(""))),
          (this["path"] = this["path"] ? this["path"] : require("path"));
        const _0x1b9854 = this["path"]["resolve"](this["dataFile"]),
          _0x577cd7 = this["path"]["resolve"](
            process["cwd"](),
            this["dataFile"]
          ),
          _0xb95263 =
    ...
    ["writedata"]() {
      if (this["isNode"]()) {
        (this["fs"] = this["fs"]
          ...
          : require("\u0066\u0073")),
          (this["path"] = this["path"] ? this["path"] : require("path"));
        const _0x18f8dd = this["path"][
            "\u0072\u0065\u0073\u006f\u006c\u0076\u0065"
          ](this["dataFile"]),
          _0x51f039 = this["path"]["resolve"](
            process["cwd"](),
            this["dataFile"]
          ),
          _0x421d4c = this["fs"]["existsSync"](_0x18f8dd),
          _0x4892e0 =
            !_0x421d4c && this["\u0066\u0073"]["existsSync"](_0x51f039),
          _0x1003bb = JSON[
            "\u0073\u0074\u0072\u0069\u006e\u0067\u0069\u0066\u0079"
          ](this["data"]);
        _0x421d4c
          ? this["fs"]["writeFileSync"](_0x18f8dd, _0x1003bb)
          : _0x4892e0
          ? this["fs"][
              "\u0077\u0072\u0069\u0074\u0065\u0046\u0069\u006c\u0065\u0053\u0079\u006e\u0063"
            ](_0x51f039, _0x1003bb)
    ...
    ["lodash_get"](_0x1f9ec4, _0x2d0253, _0x3d7e0f) {
      const _0x4ab606 = _0x2d0253["replace"](
        /\[(\d+)\]/g,
        "\u002e\u0024\u0031"
      )["split"](".");
      let _0x5999bb = _0x1f9ec4;
      for (const _0x11ce7e of _0x4ab606)
        if (
          ((_0x5999bb = Object(_0x5999bb)[_0x11ce7e]),
          void (0xb81cd ^ 0xb81cd) === _0x5999bb)
        )
          return _0x3d7e0f;
      return _0x5999bb;
    }
    ["lodash_set"](_0x1e13e2, _0x59323f, _0x5cc069) {
      return Object(_0x1e13e2) !== _0x1e13e2
        ? _0x1e13e2
        : (Array["isArray"](_0x59323f) ||
            (_0x59323f = _0x59323f["toString"]()["match"](/[^.[\]]+/g) || []),
          (_0x59323f["slice"](0x9da0c ^ 0x9da0c, -(0xd7e78 ^ 0xd7e79))[
            "reduce"
          ](
            (_0x153855, _0x1c3b5c, _0x46ba72) =>
              Object(_0x153855[_0x1c3b5c]) === _0x153855[_0x1c3b5c]
                ? _0x153855[_0x1c3b5c]
                : (_0x153855[_0x1c3b5c] =
                    Math["abs"](_0x59323f[_0x46ba72 + 0x1]) >>
                      (0x6a90a ^ 0x6a90a) ==
                    +_0x59323f[_0x46ba72 + 0x1]
                      ? []
                      : {}),
            _0x1e13e2
          )[_0x59323f[_0x59323f["length"] - 0x1]] = _0x5cc069),
          _0x1e13e2);
    }
    ["atadteg".split("").reverse().join("")](_0x240af6) {
      ...
      if (/^@/["test"](_0x240af6)) {
        const [, _0x2a0326, _0x3ed8fc] = /^@(.*?)\.(.*?)$/["exec"](_0x240af6),
          _0x403016 = _0x2a0326
            ? this["\u0067\u0065\u0074\u0076\u0061\u006c"](_0x2a0326)
            : "";
        if (_0x403016)
          try {
            const _0x553144 = JSON["parse"](_0x403016);
            _0x10c0c4 = _0x553144
              ? this["lodash_get"](_0x553144, _0x3ed8fc, "")
              : _0x10c0c4;
          } catch (_0x51e0be) {
            _0x10c0c4 = "";
          }
      ...
      if (/^@/["\u0074\u0065\u0073\u0074"](_0x45ebf3)) {
        ...
        try {
          ...
          this["\u006c\u006f\u0064\u0061\u0073\u0068\u005f\u0073\u0065\u0074"](
            ...
            (_0x46e2c4 = this["setval"](
              JSON["stringify"](_0x2eb991),
              _0x511ac3
            ));
        } catch (_0x421fd6) {
          const _0x327cf2 = {};
    ...
    ["getval"](_0x4f8fb2) {
      return this["isSurge"]() || this["isLoon"]()
        ? $persistentStore["read"](_0x4f8fb2)
        : this["isQuanX"]()
        ? $prefs["valueForKey"](_0x4f8fb2)
        : this["isNode"]()
        ? ((this["data"] = this["loaddata"]()), this["data"][_0x4f8fb2])
        : (this["data"] && this["data"][_0x4f8fb2]) || null;
    }
    ["\u0073\u0065\u0074\u0076\u0061\u006c"](_0x171167, _0x5820be) {
      return this["isSurge"]() || this["\u0069\u0073\u004c\u006f\u006f\u006e"]()
        ? $persistentStore["write"](_0x171167, _0x5820be)
        : this["isQuanX"]()
        ? $prefs["setValueForKey"](_0x171167, _0x5820be)
        : this["isNode"]()
        ? ((this["data"] =
            this["\u006c\u006f\u0061\u0064\u0064\u0061\u0074\u0061"]()),
          (this["data"][_0x5820be] = _0x171167),
          this["writedata"](),
          !0x0)
        : (this["data"] && this["data"][_0x5820be]) || null;
    }
    ["initGotEnv"](_0x2f50b9) {
      (this["got"] = this["got"] ? this["got"] : require("got")),
        ...
        _0x2f50b9 &&
          ((_0x2f50b9["headers"] = _0x2f50b9["headers"]
            ? _0x2f50b9["headers"]
            : {}),
          void 0x0 === _0x2f50b9["headers"]["Cookie"] &&
            void 0x0 === _0x2f50b9["cookieJar"] &&
            (_0x2f50b9["cookieJar"] = this["ckjar"]));
    }
    ["get"](_0x47278e, _0x9411e8 = () => {}) {
      _0x47278e["headers"] &&
        (delete _0x47278e["\u0068\u0065\u0061\u0064\u0065\u0072\u0073"][
          "Content-Type"
        ],
        ...
        this["isSurge"]() || this["isLoon"]()
          ? (this["isSurge"]() &&
              this["isNeedRewrite"] &&
              ((_0x47278e["headers"] = _0x47278e["headers"] || {}),
              Object["assign"](_0x47278e["headers"], {
          ...
          ? (this[
              ...
              ((_0x47278e["opts"] = _0x47278e["opts"] || {}),
              Object["assign"](_0x47278e["opts"], { hints: !0x1 })),
            $task["fetch"](_0x47278e)["then"](
              (_0x51ae77) => {
                const {
              ...
              (_0x3aa23d) => _0x9411e8(_0x3aa23d)
            ))
          : this["isNode"]() &&
            (this["initGotEnv"](_0x47278e),
            this["got"](_0x47278e)
              ["on"]("redirect", (_0x351234, _0x1c27f7) => {
                try {
                  if (
                    _0x351234["headers"][
                      "\u0073\u0065\u0074\u002d\u0063\u006f\u006f\u006b\u0069\u0065"
                    ...
                    const _0x368c7a = _0x351234["headers"]["set-cookie"]
                      ["map"](this["cktough"]["Cookie"]["parse"])
                      ["toString"]();
                    _0x368c7a &&
                      this["\u0063\u006b\u006a\u0061\u0072"]["setCookieSync"](
                        _0x368c7a,
                        null
                      ),
              ...
              ["then"](
                ...
                (_0x2236c7) => {
                  const { message: _0x2d973b, response: _0x2c4c24 } = _0x2236c7;
                  _0x9411e8(
                    _0x2d973b,
                    _0x2c4c24,
                    _0x2c4c24 && _0x2c4c24["body"]
                  );
                }
              ));
    }
    ["post"](_0x5b81c8, _0x2e6bc8 = () => {}) {
      if (
        (_0x5b81c8["body"] &&
          _0x5b81c8["headers"] &&
          !_0x5b81c8["headers"]["Content-Type"] &&
          (_0x5b81c8["headers"]["Content-Type"] =
            "application/x-www-form-urlencoded"),
        ...
        (_0x5b81c8["method"] = "\u0050\u004f\u0053\u0054"),
          this["isNeedRewrite"] &&
            ...
            Object["assign"](_0x5b81c8["opts"], { hints: !0x1 })),
          $task["fetch"](_0x5b81c8)["then"](
            (_0x3d3b9e) => {
              const {
        ...
        const { url: _0x3d5f56, ..._0x513aa0 } = _0x5b81c8;
        this["got"]["post"](_0x3d5f56, _0x513aa0)["then"](
          (_0xf5af63) => {
            const {
          ...
          (_0x191896) => {
            const { message: _0x155c37, response: _0x13a0ee } = _0x191896;
    ...
    ["time"](_0x3175c3, _0x4fe252 = null) {
      ...
      /(y+)/["test"](_0x3175c3) &&
        (_0x3175c3 = _0x3175c3["replace"](
          RegExp["$1"],
          (_0x34d93c["getFullYear"]() + "".split("").reverse().join(""))[
            "substr"
          ](0x4 - RegExp["$1"]["length"])
        ));
      for (let _0x2aa5eb in _0x27cae4)
        new RegExp("(" + _0x2aa5eb + ")")["test"](_0x3175c3) &&
          (_0x3175c3 = _0x3175c3["replace"](
            RegExp["$1"],
            0x1 == RegExp["$1"]["\u006c\u0065\u006e\u0067\u0074\u0068"]
              ? _0x27cae4[_0x2aa5eb]
              : ("00" + _0x27cae4[_0x2aa5eb])["substr"](
                  ("".split("").reverse().join("") + _0x27cae4[_0x2aa5eb])[
                    "length"
                  ]
                )
          ));
    ...
    ["gsm".split("").reverse().join("")](
      _0x23ef3e = _0x1759e6,
      _0x1a70e9 = "".split("").reverse().join(""),
      _0x3fd03a = "",
      _0x90aa42
    ) {
      const _0x2f8bf7 = (_0x3efd50) => {
        ...
        if ("tcejbo".split("").reverse().join("") == typeof _0x3efd50) {
          if (this["isLoon"]()) {
            ...
            return { openUrl: _0x1c4df7, mediaUrl: _0x2c197e };
          }
          if (this["isQuanX"]()) {
            let _0x38c8aa =
                _0x3efd50["open-url"] ||
            ...
            return { "open-url": _0x38c8aa, "media-url": _0x25d4e5 };
          }
          if (this["isSurge"]()) {
            let _0x3a3dc9 =
              _0x3efd50["url"] || _0x3efd50["openUrl"] || _0x3efd50["open-url"];
            return { url: _0x3a3dc9 };
          }
        }
      };
      if (
        (this["isMute"] ||
          (this["isSurge"]() || this["isLoon"]()
            ...
            : this["isQuanX"]() &&
              $notify(_0x23ef3e, _0x1a70e9, _0x3fd03a, _0x2f8bf7(_0x90aa42))),
        !this["isMuteLog"])
      ) {
        let _0x4f7ca4 = [
          "".split("").reverse().join(""),

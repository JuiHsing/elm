...
async function lottery(_0x441099) {
  ...
  const _0x1b7023 = md5(
    _0x3f3df5 +
      ...
      _0x589efa +
      "&" +
      JSON["stringify"](_0x4c8be9)
  );
  const _0x4156e1 = {
    url:
      "https://guide-acs.m.taobao.com/h5/mtop.koubei.interactioncenter.platform.right.lottery/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x5cf979 +
      "&sign=" +
      _0x1b7023 +
      "&api=mtop.koubei.interactioncenter.platform.right.lottery&v=1.0&type=originaljson&dataType=json",
    method: "POST",
    headers: _0x164482,
    body: _0x50f757,
  };
        ...
        try {
          ...
          if (isEmpty(_0x2f5905["data"]["data"])) {
            ...
            if (_0x2f5905["data"]["data"]["errorMsg"]) {
              ...
              const _0x32671a =
                _0x14c287["materialInfo"]["description"] +
                _0x14c287["materialInfo"]["title"];
...
async function lyb_sign(_0x3a3148) {
  ...
  const _0x51fe1b = {
    ...
    asac: "2A21607NIIT1ND5C4YXJ6C",
    umidtoken:
      "defaultToken2_load_failed with timeout@@https://tb.ele.me/wow/alsc/mod/b9ee9e6451bc8eda7a6afcbb@@" +
      _0x4458f1,
  };
  ...
  const _0x103a27 = {
    url:
      ...
      "&sign=" +
      _0x57f632 +
      "&api=mtop.koubei.interactioncenter.sign.component.recordsignin&v=1.0&ecode=1&type=json&valueType=string&needLogin=true&LoginRequest=true&dataType=jsonp&SV=5.0&asac=2A21607NIIT1ND5C4YXJ6C&secttid=h5%40android_chrome_87.0.4280.141",
    method: "POST",
    headers: _0x3a79b2,
    body: _0x460cf7,
  };
...
async function lyb_llk_passgame(_0xecec59, _0x150bf3, _0xa6c33a) {
  const _0x4904ee = {
    ...
    bizParam:
      '{"gameCode":"' +
      _0x150bf3 +
      '","passLevelTime":40351,"gameId":null,"token":"' +
      _0xa6c33a +
      '"}',
  };
...
async function water_reward(_0x835737, _0xa6e723) {
  const _0x3a13ad = {
    bizScene: "WATER_SORT",
    bizParam:
      '{"type":"getPassPrize","data":{"addNum":"' + _0xa6e723 + '","type":1}}',
...
function getRandom(_0x452fcd, _0x5adc25) {
  return Math["floor"](
    Math["random"]() * (_0x5adc25 - _0x452fcd + 1) + _0x452fcd
  );
}

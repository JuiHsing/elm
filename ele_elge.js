...
async function receive_yx_prize(
  _0x38f0c9,
  _0x905f0f,
  _0x7f9d6c,
  _0x277ffd,
  ...
  const _0x468b9a = {
    ...
    count: _0x8d06b4,
    extInfo:
      '{"token":"' + _0x47d2ce + '","type":"Task","count":' + _0x8d06b4 + "}",
  ...
  const _0x44ac5f = md5(
    _0x2593a6 +
      ...
      _0x21479a +
      "&" +
      JSON["stringify"](_0x468b9a)
  );
  const _0x42ef83 = {
    url:
      "https://shopping.ele.me/h5/mtop.ele.biz.growth.task.core.receiveprize/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x530179 +
      "&sign=" +
      _0x44ac5f +
      "&api=mtop.ele.biz.growth.task.core.receiveprize&v=1.0&type=originaljson&dataType=json",
    method: "GET",
    headers: _0x233d58,
    body: _0x4860d8,
  };
...
async function doReceivePrize(_0x4e4c2e, _0x3e743a, _0x3c8a89, _0xc8ed51 = 1) {
  ...
  if (_0x5246c8["indexOf"]("逛游戏专属淘宝优惠") !== -1) {
    await pageView(
      _0x3e743a,
      _0x4e4c2e["missionDefId"],
      _0x4e4c2e["missionCollectionId"],
      _0x17923d
    );
    const _0x479d50 = {
    ...
    if (_0x1ddceb["status"] === "FINISH") {
      await receive_yx_prize(
        _0x3e743a,
        _0x1ddceb["missionCollectionId"],
        _0x1ddceb["missionDefId"],
        _0x1ddceb["missionXId"],
        _0x1ddceb["id"],
        _0x3c8a89,
        _0xc8ed51
      );
      ...
      for (
        let _0x15b936 = 0;
        _0x15b936 < _0x1ddceb["missionStageDTOS"]["length"];
        _0x15b936++
      ) {
    ...
    await receive_yx_prize(
      ...
      _0x4e4c2e["missionCollectionId"],
      _0x4e4c2e["missionDefId"],
      _0x4e4c2e["missionXId"],
      _0x4e4c2e["id"],
      _0x3c8a89,
      _0x4e4c2e["nextStageCount"]
    );
  } else {
    await pageView(
      _0x3e743a,
...
async function doTask(_0x224b7b, _0x7d0fc8) {
  ...
  if (_0x31186a) {
    for (let _0x5ddfea = 0; _0x5ddfea < _0x31186a["length"]; _0x5ddfea++) {
      ...
      if (
        _0x5f12e5["actionConfig"]["actionType"] === "OPEN_APP_PUSH" &&
        _0x5f12e5["status"] === "RUNNING"
      ) {
        const _0x1aed66 = {
        ...
        if (_0x333850) {
          const _0x17a351 = {
            ...
            bizParam:
              '{"taskId":"T001","gameId":null,"token":"' + _0x7d0fc8 + '"}',
          };
        ...
        if (
          !(
            _0x5f12e5["actionConfig"]["actionType"] === "PAGEVIEW" &&
            _0x5f12e5["status"] === "RUNNING"
          )
        ) {
          continue;
...
async function receivePrize(
  ...
  let _0x5c70f1 = await commonRequest(
    _0x56f40f,
    "mtop.ele.biz.growth.task.core.receiveprize",
    _0x105b36,
    "h5%40chrome_android_87.0.4280.141"
  );
  if (_0x5c70f1) {
...
async function commonRequest(
  ...
  _0x3f2c29,
  _0x34687d,
  _0x5098ec = "1608030065155%40eleme_android_11.1.38"
) {
  const _0x40ce51 = {
    cookie: _0x1be76f,
    "user-agent":
  ...
  const _0x574efc = md5(
    _0x491d19 +
      ...
      _0x3a0486 +
      "&" +
      JSON["stringify"](_0x34687d)
  );
  const _0x42ad07 = {
    url:
      "https://guide-acs.m.taobao.com/h5/" +
      _0x3f2c29 +
      "/1.0/?jsv=2.7.0&appKey=12574478&t=" +
      _0x4b3c78 +
      "&sign=" +
      _0x574efc +
      "&api=" +
      _0x3f2c29 +
      "&v=1.0&type=originaljson&dataType=json&ttid=" +
      _0x5098ec +
      "&needLogin=true&LoginRequest=true",
    method: "GET",
    headers: _0x40ce51,
    body: _0x4ce05c,
  };
    ...
    request(_0x42ad07, async (_0x47082b, _0x5db76f, _0x4c426f) => {
      if (!_0x47082b && _0x5db76f["statusCode"] == 200) {
        try {
          ...
          if (
            isEmpty(_0x1863cd) &&
            _0x137aef["ret"][0]["indexOf"]("接口调用成功") === -1
          ) {
...
function getRandom(_0x324631, _0x4d3fb7) {
  return Math["floor"](
    Math["random"]() * (_0x4d3fb7 - _0x324631 + 1) + _0x324631
  );
}

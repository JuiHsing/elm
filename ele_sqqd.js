    ...
    _0x3954ec(_0x2306b8, async (_0x1cd459, _0x2e710c, _0xcf08c4) => {
      if (!_0x1cd459 && _0x2e710c.statusCode === 200) {
        try {
          ...
          !_0x9112a3(_0x2a9ed9.data)
            ? _0x28645b(_0x2a9ed9.data)
            : (console.log(_0x2a9ed9.ret[0]), _0x28645b(null));
        } catch (_0x58540f) {
  ...
  for (let _0x130209 = 0; _0x130209 < _0x49500c.length; _0x130209++) {
    ...
    if (!_0x317259) {
      ...
      try {
        ...
        const _0x35c91d = await sqid(
          _0x582c3d,
          "2d6d23a45cdce02bbcdda5655194284f_1705626888200;39b7f38cf1ba1e3a2210ddc2b526ae12"
        );

        _0x35c91d.communityInfo
          ? await _0x1314ba(_0x582c3d, _0x35c91d)
          : console.log("获取用户信息：" + JSON.stringify(_0x35c91d));
        _0x130209 < _0x49500c.length - 1 &&

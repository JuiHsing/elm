...
async function pageview(_0x164b86, _0x35b682, _0x3b36a8, _0x41608a) {
  const _0x39d0f6 = {
    ...
    cookie: _0x164b86,
    "x-ele-ua":
      "RenderWay/H5 AppName/wap Mozilla/5.0 (Linux; Android 8.0.0; SM-G955U Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36",
    "user-agent":
  ...
  const _0x4f9868 = md5(
    _0x13235b +
      ...
      _0x131df9 +
      "&" +
      JSON["stringify"](_0x2ee09b)
  );
  const _0x4989d5 = {
    url:
      "https://shopping.ele.me/h5/mtop.ele.biz.growth.task.event.pageview/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x9a78ab +
      "&sign=" +
      _0x4f9868 +
      "&api=mtop.ele.biz.growth.task.event.pageview&v=1.0&type=originaljson&dataType=json",
    method: "POST",
    headers: _0x39d0f6,
    body: _0x1b9d76,
  };
...
async function receive_task(_0x1bf124, _0x59b767, _0x1ec318) {
  ...
  const _0x12d4d2 = {
    ...
    missionId: _0x1ec318,
    locationInfos:
      '["{\\"lng\\":120.22057268768549,\\"lat\\":30.17862595617771}"]',
  };
  ...
  const _0x26f6c8 = md5(
    _0x186ef0 +
      ...
      _0x481058 +
      "&" +
      JSON["stringify"](_0x12d4d2)
  );
  const _0x6128de = {
    url:
      "https://shopping.ele.me/h5/mtop.ele.biz.growth.task.core.receivetask/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x32102a +
      "&sign=" +
      _0x26f6c8 +
      "&api=mtop.ele.biz.growth.task.core.receivetask&v=1.0&type=originaljson&dataType=json",
    method: "POST",
    headers: _0x40521b,
    body: _0x14c73a,
  };
...
async function query_task(_0x5b3ab4) {
  ...
  const _0x107418 = md5(
    _0x3ed92a +
      ...
      _0x3dca72 +
      "&" +
      JSON["stringify"](_0x130006)
  );
  const _0x39e4da = {
    url:
      "https://mtop.ele.me/h5/mtop.ele.biz.growth.task.core.querytask/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x5ce90d +
      "&sign=" +
      _0x107418 +
      "&api=mtop.ele.biz.growth.task.core.querytask&v=1.0&type=originaljson&dataType=json&timeout=5000&pageDomain=ele.me&ttid=1601274958480%40eleme_android_10.14.3",
    method: "GET",
    headers: _0x45c758,
    body: _0x4d159e,
  };
...
async function exchangeList(_0x323a0e) {
  ...
  const _0x1f7ca2 = md5(
    _0x3a9ed1 +
      ...
      _0xa500e0 +
      "&" +
      JSON["stringify"](_0x4351c2)
  );
  const _0x59047f = {
    url:
      "https://shopping.ele.me/h5/mtop.koubei.interactioncenter.platform.right.exchangelist/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x3f79fb +
      "&sign=" +
      _0x1f7ca2 +
...
function getRandom(_0x3ae4c0, _0x3baa04) {
  var _0x57507c = Math["floor"](
    Math["random"]() * (_0x3baa04 - _0x3ae4c0 + 1) + _0x3ae4c0
  );
  return _0x57507c;
}
...
async function ktcc(_0x301228) {
  ...
  while (!_0x16c2bb) {
    const _0x3e4db2 = {
      bizScene: "IDIOM",
      bizParam:
        '{"type":"addTaskNum","data":{"num":' + _0x5f1a5a + ',"type":4}}',
      bizMethod: "queryIndex",
    };
    ...
    const _0x4b4d10 = {
      bizScene: "IDIOM",
      bizParam:
        '{"type":"getGameGold","data":{"type":13,"request_id":' +
        _0x350675 +
        "}}",
      bizMethod: "queryIndex",
    };
    ...
    if (_0x2c7d31 && _0x2c7d31["amount"]) {
      ...
      const _0x57a440 = {
        bizScene: "IDIOM",
        bizParam:
          '{"type":"addGameGold","data":{"type":13,"request_id":' +
          _0x350675 +
          ',"ver":1,"double":4}}',
        bizMethod: "queryIndex",
      };
...
async function fanbei(_0xb5250, _0x38e7d0) {
  ...
  await pageview(
    _0xb5250,
    _0xbf274f,
    _0x4857da["missionCollectionId"],
    _0x4857da["missionDefId"]
  );
  await receive_task(
    _0xb5250,
    _0x4857da["missionCollectionId"],
...
async function kbx(_0x4a3f1f) {
  ...
  while (!_0x18f22c) {
    const _0x390534 = {
      bizScene: "IDIOM",
      bizParam:
        '{"type":"getGameGold","data":{"type":8,"request_id":' +
        _0x2ff908 +
        "}}",
      bizMethod: "queryIndex",
    };
    ...
    if (_0x147b82 && _0x147b82["amount"]) {
      ...
      const _0x19f9f5 = {
        bizScene: "IDIOM",
        bizParam:
          '{"type":"addGameGold","data":{"id":2,"type":8,"request_id":' +
          _0x2ff908 +
          ',"ver":1,"double":5}}',
        bizMethod: "queryIndex",
      };
...
async function lqjb(_0x2ccf84) {
  ...
  const _0x110ea4 = {
    bizScene: "IDIOM",
    bizParam:
      '{"type":"addGameGold","data":{"id":2,"type":1,"request_id":' +
      _0x56ebed +
      ',"ver":1,"double":1}}',
    bizMethod: "queryIndex",
  };
  ...
  const _0x1ddb52 = {
    bizScene: "IDIOM",
    bizParam:
      '{"type":"getGameGold","data":{"id":10,"type":10,"request_id":' +
      _0x56ebed +
      "}}",
    bizMethod: "queryIndex",
  };
  ...
  if (_0x1ebedd && _0x1ebedd["amount"]) {
    ...
    const _0x332acb = {
      bizScene: "IDIOM",
      bizParam:
        '{"type":"addGameGold","data":{"id":10,"type":10,"request_id":' +
        _0x56ebed +
        ',"ver":1,"double":5}}',
      bizMethod: "queryIndex",
    };
...
async function exchange(_0x27459a, _0x21e9ce) {
  ...
  const _0x2a8f66 = md5(
    _0x4d850e +
      ...
      _0x54c9e2 +
      "&" +
      JSON["stringify"](_0x48b343)
  );
  const _0x3bfc5a = {
    url:
      "https://shopping.ele.me/h5/mtop.koubei.interactioncenter.platform.right.exchange.v2/1.0/?jsv=2.6.1&appKey=12574478&t=" +
      _0x3eb0c0 +
      "&sign=" +
      _0x2a8f66 +
    ...
    request(_0x3bfc5a, async (_0x703f70, _0x180a34, _0x1131ab) => {
      if (!_0x703f70 && _0x180a34["statusCode"] == 200) {
        try {
          ...
          const _0x427801 =
            _0x16b1c2["data"]["data"][0]["discountInfo"]["amount"];
          if (_0x427801) {
...
async function duihuan(_0x3d5ec3) {
  ...
  for (let _0x28c07a = _0x47f827["length"] - 1; _0x28c07a > -1; _0x28c07a--) {
    ...
    if (
      "DISABLE" != _0x1da2d1["status"] &&
      _0x5a3f5f >= _0x1da2d1["propertyConsume"]["amount"]
    ) {
